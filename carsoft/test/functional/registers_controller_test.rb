...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { amount: @register.amount, center: @register.center, date: @register.date, destination: @register.destination, movement: @register.movement, procedensia: @register.procedensia, time: @register.time }
    end
  ...
  test "should update register" do
    put :update, id: @register, register: { amount: @register.amount, center: @register.center, date: @register.date, destination: @register.destination, movement: @register.movement, procedensia: @register.procedensia, time: @register.time }
    assert_redirected_to register_path(assigns(:register))
  end
